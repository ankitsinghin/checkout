            ...
            <div className='bg-white rounded-xl p-2 ' >
                ...
                <div className='text-s p-4 border-b '>
                    <div className='grid grid-cols-2'>
                        <p>Subtotal</p>
                        <p className='flex justify-end'>₹3570.00</p>
                    </div>
                    <div className='grid grid-cols-2'>
                        <p>Shipping</p>
                        <p className='flex justify-end'>Free</p>
                    </div>
            ...
            <div className='pt-4'>
                <div className='bg-white rounded-xl p-3 '>
                    ...
                    <p >3 coupons available</p>
                     <p className='font-semibold text-blue-900 flex justify-end'>View Coupons <MdKeyboardArrowRight className='flex top-2 items-center justify-end'/></p>
