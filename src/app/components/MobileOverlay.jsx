...
const MobileOverlay = ({ onClose }) => {
  ...
  return (
    <div className={`fixed top-0 left-0 w-full h-full bg-black bg-opacity-30 z-10 flex items-center justify-center  space-x-2`}>
      {/* Overlay */}
      <div className='bg-gray-100 rounded-2xl  space-x-4 lg:w-[65%] ss:w-[85%] md:w-[90%] flex'>
        <div className='p-4 bg-white rounded-l-2xl w-[65%] '>
          ...
          <div className='grid grid-row-3  justify-center pt-16 pb-4'>
            ...
            <div>
              ...
              <label for="orderUpdatesCheckbox" className='text-sm pl-1'>Notify me for orders updates & offers</label>
              <div className='pt-6'>
                <buttton className='flex text-sm bg-black cursor-pointer border rounded-md justify-center p-4 '>
                  ...
                  <div className='pt-1 pl-2'><FaArrowRightLong className='text-white' /></div>

                </buttton>
              </div>

            </div>
            <p className='text-smmm flex justify-center pt-2 text-gray-400'>By proceeding, I accept that I have read and
             <br/>understood the Gokwik's Privacy Policy and T&C</p>
          </div>
        ...
        <div className='h-[10%] overflow z-20 bg-gray-100 p-2 rounded-3xl' onClick={handleCloseOverlay}>
  <RxCross2 className='cursor-pointer flex rounded-3xl bg-gray-300 text-white font-extrabold' style={{ width: '26px', height: '26px' }}/>
</div>
